...
public final class MovieList {
    ...
    public static List<Movie> setupMovies() {
        ...
        String videoUrl[] = {
                Environment.getExternalStorageDirectory().getAbsolutePath()+"/"+"Wildlife.wmv",
        ...
        String bgImageUrl[] = {
                Environment.getExternalStorageDirectory().getAbsolutePath()+"/"+"vba_book_ok.png",
